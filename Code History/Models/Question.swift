...
//  Code History
//
//  Created by Andres Londono on 31/1/2023.
//

import Foundation

// Add `Hashable` conformance so that `Question` can be used in a dictionary.
struct Question: Hashable {
    ...
    static var allQuestions = [
        ...
        Question(questionText: "Computers use the digits 0 and 1 to store data. What is this system called?",
                 possibleAnswers: [
                    "Binary",
                    "Ternary",
                    "Decimal",
